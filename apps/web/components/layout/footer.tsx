    ...
    <footer className="w-full bg-[#1F5E3B] text-[#FAF8F3] border-t border-[#C89B3C]/20 pt-16 pb-8 antialiased">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-12 text-left">
        <div className="space-y-4">
          <span className="font-serif text-xl font-bold block text-[#FAF8F3]">Shri Ayurved</span>
          <p className="text-xs text-[#FAF8F3]/70 font-light leading-relaxed tracking-wide">
            Revitalizing traditional healthcare protocols through rigorous validation frameworks and authentic Vedic extraction disciplines.
          </p>
        ...
        <div>
          <h4 className="text-xs font-bold uppercase tracking-[0.2em] text-[#C89B3C] mb-4">The Pillars</h4>
          <ul className="space-y-2 text-xs text-[#FAF8F3]/80 font-medium">
            ...
            <li><Link href="/products" className="hover:text-white transition-colors">Apothecary Shop</Link></li>
            <li><Link href="/bespoke" className="hover:text-white transition-colors">Bespoke Configurations</Link></li>
          </ul>
        </div>

        <div>
          <h4 className="text-xs font-bold uppercase tracking-[0.2em] text-[#C89B3C] mb-4">Customer Care</h4>
          <ul className="space-y-2 text-xs text-[#FAF8F3]/80 font-medium">
            <li><Link href="/shipping" className="hover:text-white transition-colors">Worldwide Shipping</Link></li>
            <li><Link href="/purity" className="hover:text-white transition-colors">Lab Certificates</Link></li>
            <li><Link href="/contact" className="hover:text-white transition-colors">Consult an Acharya</Link></li>
          </ul>
        </div>
